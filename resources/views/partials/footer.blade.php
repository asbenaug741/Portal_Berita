...
<footer class="bd-footer mt-5 bg-light ">
    <div class="container py-5 d-flex bg-light">
        <div class="row">
            ...
            <div class="col-lg-3 mb-3 p-2 flex-fill bd-highlight">
                <div class="footer_widget wow fadeInRightBig animated">
                    <h2>Contact</h2>
                    <p>Untuk informasi lebih lanjut hubungi alamat di bawah ini.</p>
                    <address>Jalan Diponegoro No. 202 Telp. (024) 6921424 Fax. (024) 6921463 Ungaran 50511. </address>
                </div>
            </div>
        </div>
    </div>
